...
class TrainingConfig:
    ...
    kl_w_start: float = 0
    kl_w_end: float = 0.05
    lr_start: float = 0.000005  # 0.0002
    lr_n_period: int = 10
    lr_n_restarts: int = 100  # 30 --> n_epoch=300
    lr_n_mult: int = 1
    lr_end: float = 0.000001
    ...
    trans_ckpt: str = (
        "./checkpoints/training_1068070-4-attention-pooling_best_avg_score_0.8609873203162257_pct_match_0.465_num_epoch_41.pth"
    )
